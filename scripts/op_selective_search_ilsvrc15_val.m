...
save(['ilsvrc15_val_', num2str(first_el), '_', num2str(last_el), '.mat'], 'boxes', 'images');
save(['ilsvrc15_val_msc_', num2str(first_el), '_', num2str(last_el), '.mat'], 'gray_img_indices', 'img_indices', 'large_img_indices');
